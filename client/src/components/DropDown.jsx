...
const DropDown = ({ courier, sellerData }) => {
  ...
  const [deliveryCharge, setDeliveryCharge] = useState(8.5);
  ...
  const orderHandle = async (e) => {
    ...
    if (netAmount === 0)
      return toast.error(
        'Net amount cannot be zero. Please enter a valid quantity.'
      );
    setLoading(true);

    try {
      const response = await api.post('/order/new-order', orderDetails, {
        ...
        >
          ...
          >
            <div className="w-full flex items-end p-4 justify-between border-b border-[#0000002f]">
              <h1 className="text-[1.8rem] font-bold">Checkout</h1>
              <RxCross1
            ...
            <div className="px-5 pt-2">
              <div className="flex flex-col g-2 items-start">
                <span className="font-bold text-cyan-900 text-xl mr-1">
                  DeliveryCharge:
                  <select
                  ...
                  >
                    <option value={8.5}>Inside Dhaka</option>
                    <option value={10.0}>Outside Dhaka</option>
                  </select>
                </span>
              ...
              <div className="flex flex-col g-2 items-start">
                <div>
                  <span className="font-bold text-cyan-900 text-lg mr-1">
                    Net Amount:{' '}
                  </span>
                ...
                <div className="pt-1">
                  <ul className="text-sm text-gray-600 list-disc list-inside">
                    ...
                    <li>
                      Total Delivery Charge: {deliveryCharge * quantity || 0}
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <form onSubmit={orderHandle} className="flex flex-col gap-5 p-4">
              <div>
                <label
                  htmlFor="quantity"
