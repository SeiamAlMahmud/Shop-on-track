...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900  pt-12 pb-6 px-10 font-sans tracking-wide relative mt-10">
      <div className="mx-auto max-w-screen-2xl flex md:max-w-screen-xl">
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="flex sm:justify-between flex-wrap gap-6">
            ...
            <p className="text-gray-400 text-sm">
              © Shop on track. All rights reserved.
            </p>
          </div>
        </div>
      </div>
