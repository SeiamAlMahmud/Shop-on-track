    ...
    return (
        <Container>
            <div className="p-4">
                ...
                <div className="mt-6">
                    <h2 className=" text-sm sm:text-xl md:text-3xl font-extrabold my-7  flex justify-center gap-2 items-center">Available <span className="text-green-500 font-bold">Couriers</span> for This Item</h2>
                            ...
                            <Table style={{ tableLayout: "auto" }}>
                                <TableHead>
                                    <TableRow className="bg-gray-300">
                                        ...
                                        {
                                            userType == "customer" && <TableCell className="text-xs sm:text-sm p-1 sm:p-2">Order</TableCell>
                                        }
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {couriersList.map((courier, index) => (
                                        <TableRow key={index}>
                                            <TableCell className="text-xs sm:text-sm p-1 sm:p-2 cursor-pointer">{courier.businessName}</TableCell>
